...
const CheckOut = () => {
    ...
    console.log(courseData)
        ...
        const {coursesTitle,fee,photo_URL,blog}  = courseData ;

    return (
        <div>
            
        <div className="container p-12 mx-auto animate__animated animate__zoomIn">
            <div className="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div className="flex flex-col md:w-full">
                    <h2 className="mb-4 font-bold md:text-xl text-heading ">Student details
                    </h2>
                    <form className="justify-center w-full mx-auto" method="post" action>
                        <div className="">
                            ...
                            <div className="mt-4">
                                <button onClick={notify} className="w-full px-6 py-2 text-blue-200 bg-blue-600 hover:bg-blue-900" disabled>Process</button>
                            </div>
                        </div>
                    </form>
                </div>
                <div className="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                    <div className="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div className="mt-8">
                            <div className="flex flex-col space-y-4">
                                <div className="flex space-x-0">
                                    <div>
                                        <img src={photo_URL} alt="image" className="w-9/12"/>
                                    </div>
                                    <div>
                                        <h2 className="text-xl font-bold">{coursesTitle}</h2>
                                        <p className="text-sm">{blog.slice(0,100)}</p>
                                        <span className="text-red-600">Price</span> ${fee}
                                    </div>
                        ...
                        <div
                            ...
                            Subtotal<span className="ml-2">${fee}</span></div>
                        <div
                            className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Gov. Tax<span className="ml-2">$0</span></div>
                        <div
                            className="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Total<span className="ml-2">${fee}</span></div>
                    </div>
                </div>
            </div>
            <ToastContainer />
